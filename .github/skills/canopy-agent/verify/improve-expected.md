...
- [ ] All VALIDATE Errors and Warnings from step 3 have been fixed
- [ ] Every misplaced category file has been relocated per `policies/category-decision-flowchart.md`
...
- [ ] If skill makes changes to files: `VERIFY_EXPECTED` node present in the success branch and `verify/verify-expected.md` exists
