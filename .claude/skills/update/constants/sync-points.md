...
| `FRONTMATTER_CHANGE` | `src/providers/diagnosticsProvider.ts` (`FRONTMATTER_REQUIRED`, `FRONTMATTER_ALLOWED`); `src/providers/completionProvider.ts` (`FRONTMATTER_KEYS`); `src/providers/hoverProvider.ts` (`FRONTMATTER_DOCS`) |
