...
* update
  ...
  * IF << docs/CHANGELOG.md does not already contain an entry for `context.current_version`
    * Update `docs/CHANGELOG.md` to document the canopy version bump and all applied changes
